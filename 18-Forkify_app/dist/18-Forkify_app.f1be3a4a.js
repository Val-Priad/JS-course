...
var $0edd2da8584ff21b$var$toString = $1eab7b706e02b706$exports(1.1.toString);
...
const $949cefe0e606d775$export$a9861bd62f48e142 = `cf5ac53a-206b-45f9-a71b-5faf5b4b6ff6`;
const $949cefe0e606d775$export$196440f71ed9f601 = 10;
const $949cefe0e606d775$export$d2f17d20365655cb = 10;
const $949cefe0e606d775$export$8685844b22724b3f = 1000;
...
const $8655b94003061a8a$export$2b3ff41fecbef7c8 = async function(url, uploadData) {
    try {
        const fetchReq = uploadData ? fetch(url, {
            method: "POST",
            headers: {
...
const $8655b94003061a8a$export$39e0fd3547bcb345 = async function(url, uploadData) {
    try {
...
const $f821677b80d93c23$export$ca000e230c0caa3e = {
    search: {
        query: "",
        results: [],
        resultsPerPage: $949cefe0e606d775$export$d2f17d20365655cb,
        currentPage: 1
    }
};
const $f821677b80d93c23$var$createRecipeObj = (recipe)=>{
    return {
        id: recipe.id,
        title: recipe.title,
...
const $f821677b80d93c23$export$b96725c7a035d60b = async function(id) {
    try {
        const data = await (0, $8655b94003061a8a$export$2b3ff41fecbef7c8)(`${$949cefe0e606d775$export$923ea8233b386e99}${id}`);
        let { recipe: recipe } = data.data;
        $f821677b80d93c23$export$ca000e230c0caa3e.recipe = $f821677b80d93c23$var$createRecipeObj(recipe);
        if ($f821677b80d93c23$export$ca000e230c0caa3e?.bookmarks?.some((recipe)=>recipe.id === $f821677b80d93c23$export$ca000e230c0caa3e.recipe.id)) $f821677b80d93c23$export$ca000e230c0caa3e.recipe.bookmarked = true;
    } catch (err) {
        throw err;
    }
};
const $f821677b80d93c23$export$202b8e5cb363a0c4 = async (query)=>{
    try {
        const data = await (0, $8655b94003061a8a$export$2b3ff41fecbef7c8)(`${$949cefe0e606d775$export$923ea8233b386e99}?search=${query}&key=${$949cefe0e606d775$export$a9861bd62f48e142}`);
        ...
        $f821677b80d93c23$export$ca000e230c0caa3e.search.currentPage = 1;
    } catch (err) {
        throw err;
    }
};
const $f821677b80d93c23$export$8d7f79465139ab72 = function(page = $f821677b80d93c23$export$ca000e230c0caa3e.search.currentPage) {
    $f821677b80d93c23$export$ca000e230c0caa3e.search.currentPage = page;
...
const $f821677b80d93c23$export$5e23f4642ecad5ea = (servings)=>{
    $f821677b80d93c23$export$ca000e230c0caa3e.recipe.ingredients = $f821677b80d93c23$export$ca000e230c0caa3e.recipe.ingredients.map((ingredient)=>{
        if (!ingredient.quantity) return ingredient;
        ingredient.quantity = ingredient.quantity / $f821677b80d93c23$export$ca000e230c0caa3e.recipe.servings * servings;
        return ingredient;
    });
    $f821677b80d93c23$export$ca000e230c0caa3e.recipe.servings = servings;
};
const $f821677b80d93c23$export$72009cc673d27d80 = function(recipe) {
    if (!$f821677b80d93c23$export$ca000e230c0caa3e.bookmarks) $f821677b80d93c23$export$ca000e230c0caa3e.bookmarks = [];
...
const $f821677b80d93c23$export$136048bcb9946c75 = function(id) {
    ...
    $f821677b80d93c23$export$ca000e230c0caa3e.bookmarks.splice($f821677b80d93c23$export$ca000e230c0caa3e.bookmarks.findIndex((recipe)=>recipe.id === id), 1);
    $f821677b80d93c23$var$persistBookmarks();
};
...
const $f821677b80d93c23$export$d660c2254e74960d = async function(newRecipe) {
    try {
        let ingredients = Object.entries(newRecipe).filter((entry)=>{
            if (entry[0].startsWith("ingredient") && entry[1] !== "") return entry;
        }).map((ingredient)=>{
            const ingredientArr = ingredient[1].split(",").map((el)=>el.trim());
            if (ingredientArr.length !== 3) throw new Error(`Wrong ingredient format please use the correct format "qty,unit,description", skip value, but not comma. Example ",,salt"!`);
        ...
        const data = await (0, $8655b94003061a8a$export$2b3ff41fecbef7c8)(`${$949cefe0e606d775$export$923ea8233b386e99}?key=${$949cefe0e606d775$export$a9861bd62f48e142}`, recipe);
        const recipeResponse = data.data.recipe;
        recipeResponse.key = $949cefe0e606d775$export$a9861bd62f48e142;
        $f821677b80d93c23$export$ca000e230c0caa3e.recipe = $f821677b80d93c23$var$createRecipeObj(recipeResponse);
    ...
    _generateIngredient(ingredient) {
        return `
            <li class="recipe__ingredient">
              ...
              <div class="recipe__quantity">${ingredient.quantity ? (0, (/*@__PURE__*/$parcel$interopDefault($e7d84b30bb9cd8ce$exports)))(ingredient.quantity) : ""}</div>
    ...
    _generateMarkup() {
        ...
        <div class="recipe__details">
          ...
          <button class="btn--round btn--bookmark">
            <svg class="">
              <use href="${0, (/*@__PURE__*/$parcel$interopDefault($d0367fa1fc51ee10$exports))}#icon-bookmark${this._data.bookmarked ? "-fill" : ""}"></use>
            </svg>
          </button>
        </div>
...
var $14d5a89801d55f2c$export$2e2bcd8739ae039 = $14d5a89801d55f2c$var$PreviewView;


class $3b3a807ebcd3404d$var$ResultsView extends (0, $14d5a89801d55f2c$export$2e2bcd8739ae039) {
...
class $5346de1ad3f80d2d$var$BookmarksView extends (0, $14d5a89801d55f2c$export$2e2bcd8739ae039) {
...
class $ea55b24677fb9333$var$PaginationView extends (0, $66df3411d2d6676e$export$2e2bcd8739ae039) {
    ...
    _generateMarkup() {
        ...
        if (this._data.currentPage === 1 && numPages > 1) return this._generateMarkupButtonNext();
        if (this._data.currentPage === numPages && numPages > 1) return this._generateMarkupButtonPrevious();
        if (this._data.currentPage < numPages) return `${this._generateMarkupButtonPrevious()}
...
//
const $51e55805949f51d8$var$controllerRecipes = async ()=>{
    try {
        const id = window.location.hash.slice(1);
        if (!id) return;
        ...
        (0, $87c8fee486b3a62a$export$2e2bcd8739ae039).renderError(error);
    }
};
const $51e55805949f51d8$var$controllerSearchResults = async ()=>{
    try {
        (0, $3b3a807ebcd3404d$export$2e2bcd8739ae039).renderSpinner();
        const query = (0, $cc3ccfe7a9f0c093$export$2e2bcd8739ae039).getQuery();
        if (!query) return;
        (0, $cc3ccfe7a9f0c093$export$2e2bcd8739ae039).clearInput();
...
const $51e55805949f51d8$var$controllerPagination = (page)=>{
    (0, $3b3a807ebcd3404d$export$2e2bcd8739ae039).render($f821677b80d93c23$export$8d7f79465139ab72(page));
    (0, $ea55b24677fb9333$export$2e2bcd8739ae039).render($f821677b80d93c23$export$ca000e230c0caa3e.search);
};
const $51e55805949f51d8$var$controllerServings = (newServings)=>{
...
const $51e55805949f51d8$var$controllerToggleBookmark = ()=>{
...
const $51e55805949f51d8$var$controllerBookmarks = ()=>{
    (0, $5346de1ad3f80d2d$export$2e2bcd8739ae039).render($f821677b80d93c23$export$ca000e230c0caa3e.bookmarks);
};
const $51e55805949f51d8$var$controllerAddRecipe = async function(newRecipe) {
    try {
        (0, $3a43958ee387c94d$export$2e2bcd8739ae039).renderSpinner();
        await $f821677b80d93c23$export$d660c2254e74960d(newRecipe);
        window.location.hash = "#" + $f821677b80d93c23$export$ca000e230c0caa3e.recipe.id;
        (0, $5346de1ad3f80d2d$export$2e2bcd8739ae039).render($f821677b80d93c23$export$ca000e230c0caa3e.bookmarks);
        (0, $87c8fee486b3a62a$export$2e2bcd8739ae039).render($f821677b80d93c23$export$ca000e230c0caa3e.recipe);
        (0, $3a43958ee387c94d$export$2e2bcd8739ae039).renderMessage();
        setTimeout(()=>{
            (0, $3a43958ee387c94d$export$2e2bcd8739ae039).toggleWindow();
        }, $949cefe0e606d775$export$8685844b22724b3f);
    } catch (error) {
        (0, $3a43958ee387c94d$export$2e2bcd8739ae039).renderError(`${error.message}`);
    }
};
const $51e55805949f51d8$var$init = function() {
    (0, $5346de1ad3f80d2d$export$2e2bcd8739ae039).addHandlerRender($51e55805949f51d8$var$controllerBookmarks);
    (0, $87c8fee486b3a62a$export$2e2bcd8739ae039).addHandlerRender($51e55805949f51d8$var$controllerRecipes);
    (0, $87c8fee486b3a62a$export$2e2bcd8739ae039).addHandlerUpdateServings($51e55805949f51d8$var$controllerServings);
    (0, $87c8fee486b3a62a$export$2e2bcd8739ae039).addHandlerAddBookmark($51e55805949f51d8$var$controllerToggleBookmark);
    (0, $cc3ccfe7a9f0c093$export$2e2bcd8739ae039).addHandlerSearch($51e55805949f51d8$var$controllerSearchResults);
    (0, $ea55b24677fb9333$export$2e2bcd8739ae039).addHandlerClick($51e55805949f51d8$var$controllerPagination);
    (0, $3a43958ee387c94d$export$2e2bcd8739ae039).addHandlerUpload($51e55805949f51d8$var$controllerAddRecipe);
};
$51e55805949f51d8$var$init();


//# sourceMappingURL=18-Forkify_app.f1be3a4a.js.map
